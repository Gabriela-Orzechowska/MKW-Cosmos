...
bool IsOnlineMenu(MenuId id); //80860484 online but outside of races 
...
MenuCategory IsGameplayMenu(MenuId id); //808609fc
...
bool IsTournamentMenu(MenuId id); //808604e0
bool IsGhostRaceMenu(MenuId id); //808604c0
