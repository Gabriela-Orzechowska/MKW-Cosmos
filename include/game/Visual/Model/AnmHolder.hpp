...
public:
    //no ctor
    virtual float GetFrameCount() = 0; //0x8
    virtual float GetFrame() const = 0; //0xc
    virtual void SetFrame(float frame) = 0; //0x10
    virtual void UpdateRateAndSetFrame(float frame) = 0; //0x14
    virtual float GetUpdateRate() const = 0; //0x18
    virtual void SetUpdateRate(float rate) = 0; //0x1c
    virtual u32 IsLooped() = 0; //0x20
    u32 idx;
    u8 unknown_0x8[4];
...
public:
    //no ctor
    float GetFrameCount() override; //8055ae90 vtable 808b4430
    ...
    u32 IsLooped() override; //8055af14
};

class AnmTexPatHolder : public AnmHolder{
public:
    //no ctor
    float GetFrameCount() override; //8055a9a4 vtable 808b4340
    ...
    u32 IsLooped() override; //8055aa28
};
