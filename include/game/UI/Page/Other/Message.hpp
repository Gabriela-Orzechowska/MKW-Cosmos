...
public:
    ...
    ~Click() override; //805f8de0 vtable 808b9c70
...
class MessageBoxTransparent : public Click { //0x4d used for drift explanation, pressing A goes back to page "under"
public:
    ...
    virtual void SetMessageWindowText(u32 bmgId, const TextInfo *text); //0x68 805f9244
    virtual void SetButtonImage(); //0x6c 805f92d4
    u8 unknown_0x1A4;
    u8 padding[3];
...
class MessageBox : public Click{ //0x51, 0xc8 and probably others just a message box where pressing A goes to another page
public:
    MessageBox(); //805f931c
    ...
    virtual void SetMessageWindowText(u32 bmgId, const TextInfo *text); //0x68 805f9628 
    virtual void SetButtonImage(); //0x6c 805f9630
