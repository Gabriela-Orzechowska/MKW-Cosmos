...
namespace Pages{
class VSRaceEnd : public RaceMenu{ //0x22
public:
    VSRaceEnd(); //80624e48
    ...
    u32 *GetVariantsIdxArray() const override; //0x70 80632af4
    bool IsPausePage() override; //0x74 80632ab4
    char *GetButtonsBRCTRName() const override; //0x78 80632abc
};//0x344
