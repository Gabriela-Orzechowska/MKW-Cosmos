...
public:
    ...
    virtual bool CanEnd(); //0x40 807f5f9c returns true if menu != TT gameplay AND if timer€[0.05,0.5]
    virtual char *GetButtonBRCTRName() const; //0x44 807f5f20, based on menuId
