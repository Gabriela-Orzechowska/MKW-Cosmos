...
void ApplyWiiLinkPatch(int param_1, int param_2, int param_3, int param_4, int param_5, int param_6)
{
    if (s_payloadReady)
    {
        s_hasFinished = true;
...
kmBranch(0x800ed6e8, ApplyWiiLinkPatch);
