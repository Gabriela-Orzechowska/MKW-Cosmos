...
namespace detail{
	...
	static_assert(sizeof(SoundArchiveFileReader) == 0x44, "SoundArchiveFileReader");
}
	...
	static_assert(sizeof(NandSoundArchive) == 0x1DC, "NandSoundArchive");
	...
	static_assert(sizeof(MemorySoundArchive) == 0x150, "MemorySoundArchive");
}//namespace snd
}//namespace nw4r
