...
static_assert(sizeof(CtrlMenuObiTop) == 0x174, "CtrlMenuObiTop");
...
static_assert(sizeof(CtrlMenuBackButton) == 0x264,"CtrlMenuBackButton");
...
static_assert(sizeof(CtrlMenuDummyBack) == 0x18c,"CtrlMenuDummyBack");
#endif