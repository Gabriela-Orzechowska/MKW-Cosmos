...
static_assert(sizeof(CtrlMenuBattleCupSelectCup) == 0x7d4, "CtrlMenuBattleCupSelectCup");
...
static_assert(sizeof(CtrlMenuBattleCupSelectStage) == 0x8b8, "CtrlMenuBattleCupSelectStage");
#endif