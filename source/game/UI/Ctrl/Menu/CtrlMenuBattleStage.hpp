...
static_assert(sizeof(StageButton) == 0x26c,"StageButton");
...
static_assert(sizeof(CtrlMenuBattleStageSelectCupSub) == 0x18c, "CtrlMenuBattleStageSelectCupSub");
...
static_assert(sizeof(CtrlMenuBattleStageSelectCup) == 0x48c, "CtrlMenuBattleStageSelectCup");
...
static_assert(sizeof(CtrlMenuBattleStageSelectStage) == 0xF2C, "CtrlMenuBattleStageSelectStage");
